...
[ClosedPrice10, price10, error10, time10] = GMRES_Low_Rank_DataPoints(29, 19, nt, S0, V0, cnIterations);
[ClosedPrice20, price20, error20, time20] = GMRES_Low_Rank_DataPoints(39, 29, nt, S0, V0, cnIterations);
[ClosedPrice30, price30, error30, time30] = GMRES_Low_Rank_DataPoints(49, 39, nt, S0, V0, cnIterations);
[ClosedPrice40, price40, error40, time40] = GMRES_Low_Rank_DataPoints(59, 49, nt, S0, V0, cnIterations);
[ClosedPrice50, price50, error50, time50] = GMRES_Low_Rank_DataPoints(69, 59, nt, S0, V0, cnIterations);
[ClosedPrice100, price100, error100, time100] = GMRES_Low_Rank_DataPoints(79, 69, nt, S0, V0, cnIterations);
% [ClosedPrice200, price200, error200, time200] = ALS_DataPoints(29, 19, 100, S0, V0, 200);
% [ClosedPrice300, price300, error300, time300] = ALS_DataPoints(29, 19, 100, S0, V0, 300);
