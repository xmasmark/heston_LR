function MU = HestonExplicitLowRankRTildaRC3(params,K,r,q,S,V,T,epsilon)
...
function D = MDerivative_BETTER(L, delta)
    ...
    % Calculate the first derivative using vectorized operations
...
function D = MSecondDerivative_BETTER(L, delta)
    ...
    % Calculate the second derivative using vectorized operations
